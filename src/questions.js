...
export const trainingQuestions = [
    ...
    },
    {
      ...
      options: [
        { id: 'q3a', label: 'Yah that makes my day!', value: 0.9 },
    ...
    {
      id: 'q5',
      question: 'Imagine you have a absolutely delicious pizza. An obscured wet floor causes you to slip and drop your pizza on the floor.',
      options: [
        ...
        { id: 'q5d', label: 'R.i.P, pizza.', value: 0.5 },
      ],
    },
  ];
  ...
  export const validationQuestions = [
    ...
    },
    {
        ...
        options: [
          ...
          { id: 'vq2c', label: 'Most of the times', value: 0.8 },
